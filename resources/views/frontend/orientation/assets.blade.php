<style type="text/css">
    ...
    <link
      ...
      href="{{asset('assets/frontend/content/wp-content/uploads/sites/8/elementor/css/post-7048d.css?ver=1692006534')}}"
      type="text/css"
      media="all"
    />
    <link
    ...
    <link
      ...
      href="{{asset('assets/frontend/json/wp-json/wp/v2/pages/7.json')}}"
    />
    <link
      rel="EditURI"
