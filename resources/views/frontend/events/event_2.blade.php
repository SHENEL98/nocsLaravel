                                                                        ...
                                                                        <div class="eael-post-grid eael-post-appender eael-post-appender-363e5c0 eael-post-grid-style-three"
                                                                            ...
                                                                            @for ($j = 1; $j < 10; $j++)
                                                                                ...
                                                                                @if (is_dir($folderPath))
                                                                                    @includeWhen(View::exists(
                                                                                            'frontend.events.event_1_activity_' .
                                                                                                $j),
                                                                                        'frontend.events.event_1_activity_' .
                                                                                            $j)
                                                                                @endif
                                                                                ...
                                                                                @for ($i = 1; $i < 10; $i++)
                                                                                    ...
                                                                                    @if (file_exists(public_path($imagePath)))
                                                                                        <article
                                                                                            class="eael-grid-post eael-post-grid-column">
                                                                                            <div
                                                                                                class="eael-grid-post-holder">
                                                                                                <div
                                                                                                    class="eael-grid-post-holder-inner">
                                                                                                    <div
                                                                                                        class="container-slider">
                                                                                                        <div
                                                                                                            class="eael-entry-media">
                                                                                                            <div
                                                                                                                class="eael-entry-thumbnail">
                                                                                                                <img loading="lazy"
                                                                                                                    width="768"
                                                                                                                    height="512"
                                                                                                                    onclick="handleImageClick('{{ asset($imagePath) }}')"
                                                                                                                    src="{{ asset($imagePath) }}"
                                                                                                                    class="attachment-medium_large size-medium_large wp-image-4082"
                                                                                                                    alt="ylo"
