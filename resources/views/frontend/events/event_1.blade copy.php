...
@section('content')
@include('frontend/events/events_assets')
                                        ...
                                        <div
                                          ...
                                          <script>
                                            ...
                                            for (let i = 1; i < 14; i++) {
                                              ...
                                              image +=
                                                '<i class="fas fa-plus" aria-hidden="true"></i><a href="2023/05/10/the-new-rules-of-personal-finance-in-wealth/index.html"></a>';
                                              image +=
                                                '</div> <div class="eael-entry-thumbnail">';
                                              image +=
                                                '<img loading="lazy" width="768" height="512" src="{{asset('assets/src/event_1/activity_1/"+ i + ".jpg')}}" class="attachment-medium_large size-medium_large wp-image-4082"  decoding="async" sizes="(max-width: 768px) 100vw, 768px" />';
                                                '<img loading="lazy" width="768" height="512" src="{{asset('assets/src/event_1/activity_1/"+ i + ".jpg')}}" class="attachment-medium_large size-medium_large wp-image-4082"  decoding="async" sizes="(max-width: 768px) 100vw, 768px" />';
                                              image += "</div>";
                                              image += "</div>";
